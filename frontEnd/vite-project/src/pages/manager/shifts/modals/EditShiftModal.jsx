...
const EditShiftModal = ({
  ...
  const handleDT = (name) => (val) =>
    onEditChange({ target: { name, value: val } })
  ...
  const handleMobileStartChange = (e) => {
    ...
    if (
      editingShift.shiftEndTime &&
      v &&
      new Date(editingShift.shiftEndTime) <= new Date(v)
    ) {
          ...
          <div className="space-y-4">
            ...
            <div className="w-full">
              ...
              <input
                ...
                onChange={(e) =>
                  onEditChange({
                    target: { name: 'shiftEndTime', value: e.target.value },
                  })
                }
