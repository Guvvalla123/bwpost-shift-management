...
import {
  X, CalendarDays, Clock, Timer, Trash2,
      ...
      >
        ...
        <div className="p-6 border-b border-gray-100 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <p className="text-sm font-bold text-gray-800">{formatDate(shift.shiftStartTime)}</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <p className="text-sm font-bold text-gray-800">{formatTime(shift.shiftStartTime)}</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <p className="text-sm font-bold text-gray-800">{formatTime(shift.shiftEndTime)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          ...
          <div className="flex items-end justify-between mb-3">
            <div>
              <span className="text-3xl font-bold text-gray-900 tabular-nums">{filledSlots}</span>
              <span className="text-gray-400 text-lg font-medium">/{totalSlots}</span>
              <span className="ml-2 text-xs text-gray-400">employees assigned</span>
            </div>
            <span
              className="text-2xl font-bold tabular-nums"
              style={{ color: fillPercent >= 100 ? "#10b981" : fillPercent >= 60 ? "#3b82f6" : "#f59e0b" }}
            >
              {fillPercent}%
            </span>
          </div>
